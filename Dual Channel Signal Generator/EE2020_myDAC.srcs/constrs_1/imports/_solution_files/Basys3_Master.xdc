...
##Buttons
set_property PACKAGE_PIN U18 [get_ports {pbcenter}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {pbcenter}]
set_property PACKAGE_PIN T18 [get_ports {pbup}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {pbup}]
set_property PACKAGE_PIN W19 [get_ports {pbleft}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {pbleft}]
set_property PACKAGE_PIN T17 [get_ports {pbright}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {pbright}]
set_property PACKAGE_PIN U17 [get_ports {pbdown}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {pbdown}]
